...
const SidebarContent = ({onClose, ...rest}) => {
    return (
        <Box
            ...
            h="full"
            {...rest}>
            <Flex h="12" flexDirection="column" alignItems="center" mx="8" mb={75} mt={2} justifyContent="space-between">
                <Text fontSize="2xl" fontFamily="monospace" fontWeight="bold" mb={5} color="white">
                    Dashboard
                </Text>
                <Flex alignItems="flex-end">
                <AiFillCodeSandboxSquare size="40" color="#FF5733" />
                <Text fontSize="2xl" fontFamily="monospace" fontWeight="bold" ml={2} color="white">
                    ClientTrack
                </Text>
                </Flex>
...
const MobileNav = ({id, onOpen, ...rest}) => {
