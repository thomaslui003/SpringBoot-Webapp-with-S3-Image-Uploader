...
import com.thomascode.s3.S3Service;
import org.apache.commons.lang3.StringUtils;
import com.thomascode.s3.S3Buckets;
import java.io.IOException;
import java.util.UUID;

import com.thomascode.exception.DuplicateResourceException;
import com.thomascode.exception.RequestValidationException;
import com.thomascode.exception.ResourceNotFoundException;
...
public class CustomerService {
    ...
    public void updateCustomer(Integer customerId,
        ...
        // TOD: for JPA use .getReferenceById(customerId) as it does does not bring object into memory and instead a reference
    ...
    /**
     * Uploads a customer's profile image to the specified S3 bucket.
     *
     * @param customerId the ID of the customer
     * @param file the profile image file to be uploaded
     * @throws RuntimeException if an I/O error occurs during file upload
     */
    ...
    public byte[] getCustomerProfileImage(Integer customerId){
        ...
        //to do: check if profileimageid is empty or not
